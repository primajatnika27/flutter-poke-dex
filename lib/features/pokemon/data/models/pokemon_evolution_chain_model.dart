...
class Chain {
  ...
  factory Chain.fromJson(Map<String, dynamic> json) => Chain(
    evolutionDetails: List<dynamic>.from(json["evolution_details"].map((x) => x)),
    evolvesTo: List<ChainEvolvesTo>.from(json["evolves_to"].map((x) => ChainEvolvesTo.fromJson(x))),
    isBaby: json["is_baby"],
    species: Species.fromJson(json["species"]),
  );

  Map<String, dynamic> toJson() => {
    "evolution_details": List<dynamic>.from(evolutionDetails.map((x) => x)),
...
class ChainEvolvesTo {
  ...
  factory ChainEvolvesTo.fromJson(Map<String, dynamic> json) => ChainEvolvesTo(
    evolutionDetails: List<EvolutionDetail>.from(json["evolution_details"].map((x) => EvolutionDetail.fromJson(x))),
    evolvesTo: List<EvolvesToEvolvesTo>.from(json["evolves_to"].map((x) => EvolvesToEvolvesTo.fromJson(x))),
    isBaby: json["is_baby"],
    species: Species.fromJson(json["species"]),
  );
...
class EvolvesToEvolvesTo {
  ...
  factory EvolvesToEvolvesTo.fromJson(Map<String, dynamic> json) => EvolvesToEvolvesTo(
    evolutionDetails: List<EvolutionDetail>.from(json["evolution_details"].map((x) => EvolutionDetail.fromJson(x))),
