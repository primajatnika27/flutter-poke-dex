...
class GenerationIii {
  ...
  factory GenerationIii.fromJson(Map<String, dynamic> json) => GenerationIii(
    ...
    rubySapphire: FireredLeafgreen.fromJson(json["ruby-sapphire"]),
  );
...
class GenerationIv {
  ...
  factory GenerationIv.fromJson(Map<String, dynamic> json) => GenerationIv(
    ...
    heartgoldSoulsilver: DiamondPearl.fromJson(json["heartgold-soulsilver"]),
    platinum: DiamondPearl.fromJson(json["platinum"]),
  );
...
class BlackWhite {
  ...
  factory BlackWhite.fromJson(Map<String, dynamic> json) => BlackWhite(
    animated: Showdown.fromJson(json["animated"]),
    backDefault: json["back_default"],
    backFemale: json["back_female"],
    backShiny: json["back_shiny"],
    backShinyFemale: json["back_shiny_female"],
...
class GenerationVi {
  ...
  factory GenerationVi.fromJson(Map<String, dynamic> json) => GenerationVi(
    omegarubyAlphasapphire: Home.fromJson(json["omegaruby-alphasapphire"]),
    xY: Home.fromJson(json["x-y"]),
  );
